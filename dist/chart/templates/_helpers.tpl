...
*/}}
{{- define "vaultweaver.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "vaultweaver.resourceName" -}}
{{- $fullname := include "vaultweaver.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "vaultweaver.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "vaultweaver.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
